...
from pulpcore.cli.maven.context import PulpMavenDistributionContext, PulpMavenRepositoryContext, PulpMavenRemoteContext
...
remote_option = resource_option(
    ...
    help=_("Remote used for downloading content that is not yet in Pulp."
